...
public static class UITheme
{
    ...
    public const float AutoToggleRowHeight = 96f;
    public const float ActionButtonHeight = 72f;
    public const float ForgeButtonHeight = 80f;
    public const float ForgeTimerHeight = 32f;

    public const float ForgeTimerTopOffset = HeaderHeight + 8f;
    public const float ForgeButtonTopOffset = ForgeTimerTopOffset + ForgeTimerHeight + SectionGap;
    public const float AutoForgePanelTopOffset = ForgeButtonTopOffset + ForgeButtonHeight + SectionGap;
    public const float ForgeZoneHeight = AutoForgePanelTopOffset + AutoToggleRowHeight - HeaderHeight;
